...
<?php
		$id_resep=$_GET['id'];
		require "conn.php";
		$commentquery = mysql_query("SELECT * FROM komentar_resep WHERE id_resep='$id_resep' ORDER BY tgl_komentar ASC") or die(mysql_error());
    ...
    $("#tes" + kode).click(function(){
        $("#balas"+ kode).toggle(1000);
				...
				<div id="balas<?php echo $row['kd_komentar'];?>" style="display:none;">
					<form name="tambah_komentar_resep" method='post' action="dasar.php?page=tambah_komentar_resep&kd=<?=$row['kd_komentar']?>">
			...
			//-----------------------------------
			$commentquery2 = mysql_query("SELECT * FROM komentar_resep WHERE kd_turunan='$kode' ORDER BY tgl_komentar ASC") or die(mysql_error());
			...
			<?php
			//ngambil nama anggota yang komentar
			$id_anggota2=$row2['id_anggota'];
			$sql2= mysql_query("SELECT * from anggota WHERE id_anggota = '$id_anggota2'") or die(mysql_error());
    ...
    $("#tes" + kode).click(function(){
        $("#balas"+ kode).toggle(1000);
				...
				<div id="balas<?php echo $row2['kd_komentar'];?>" style="display:none;">
					<form name="tambah_komentar_resep" method='post' action="dasar.php?page=tambah_komentar_resep&kd=<?=$row2['kd_komentar']?>">
						<h3>Tulis Balasan Anda</h3>
						<div class='form-group'>
							<input class='form-control' name="id_resep" value="<?php echo $id_resep;?>" type='hidden'>
						</div>
			...
			$kode2 = $row2['kd_komentar'];
			echo "<hr>";
			
			//-----------------------------------
			$commentquery3 = mysql_query("SELECT * FROM komentar_resep WHERE kd_turunan='$kode2' ORDER BY tgl_komentar ASC") or die(mysql_error());
    ...
    $("#tes" + kode).click(function(){
        $("#balas"+ kode).toggle(1000);
				...
				<div id="balas<?php echo $row3['kd_komentar'];?>" style="display:none;">
					<form name="tambah_komentar_resep" method='post' action="dasar.php?page=tambah_komentar_resep&kd=<?=$row3['kd_komentar']?>">
						<h3>Tulis Balasan Anda</h3>
						<div class='form-group'>
							<input class='form-control' name="id_resep" value="<?php echo $id_resep;?>" type='hidden'>
						</div>
			...
			//-----------------------------------
			$commentquery4 = mysql_query("SELECT * FROM komentar_resep WHERE kd_turunan='$kode' ORDER BY tgl_komentar ASC") or die(mysql_error());
