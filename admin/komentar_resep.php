	...
	<!------------------------- TABS MACAM DATA ---------------------------->
		...
		<table border="0" align="center" class="table table-hover">
			...
			<?php
				...
				$query="select * from komentar_resep limit $posisi,$batas ";
			...
			<tbody>
				<tr>
					...
					<!--kelola-->
					<td align='center'>
						<a onclick="return confirm('Apakah Anda yakin akan menghapus data ini?')" href="dasar.php?page=hapus_komentar_resep&id_anggota=<?php echo $r['id_anggota'];?>&id_resep=<?php echo $r['id_resep'];?>&isi=<?php echo $r['isi_komentar'];?>"><span class="glyphicon glyphicon-trash"></span></a>
					</td>
		...
		<div class='page'>
			<ul class="pagination">
				...
				<?php 	
					...
					$sql_paging = mysql_query("select isi_komentar from komentar_resep");
