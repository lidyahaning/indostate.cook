	...
	<div class="table-responsive">
		...
		<td>
			<form method="post" name="cari" action="dasar.php?page=cari_anggota">
				<b>Cari Data :</b></span><input type="" class="form-control" name="data" placeholder="Masukkan Nama Anggota"><br>
			</form>
		</td>
		</tr>
		</table>
			...
			<div class='page'>
				<ul class="pagination">
					...
					include "conn.php";
						...
						$sql_paging = mysql_query("select id_anggota from anggota");
						$jmldata = mysql_num_rows($sql_paging) or die (mysql_error());
						$jumlah_halaman = ceil($jmldata / $batas);
						for($i = 1; $i <= $jumlah_halaman; $i++)
						{
						  echo "<font style='padding:10px;'><a href=dasar.php?page=anggota&halaman=$i&$no> $i </a></font>";
						}
						$i=$i-1;
					?>
					</li>
