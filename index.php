	...
	<form method="post" name="cari" action="dasar.php?page=hasil2">
		<div class="form-group">
			<table border="0" align="right">
				<tr>
					<td width="250">
						<input name="nama_resep" class="form-control" name="nama" placeholder="Masukkan Nama Masakan" title="Pencarian Resep Masakan">
					</td>
					<td width="80" align='right'>
						<button type="submit" class="btn btn-default">Cari <span class="glyphicon glyphicon-search"></span></a></button>
					</td>
				</tr>
			</table>
		</div>
  ...
  <div class="col-sm-7">
	<div class="slide">
		<div id="carousel-example-generic" class="carousel slide">
			<!-- Indicators (untuk titik pilihan di bawah slide) -->
			...
			<div class="carousel-inner">
				<div class="item active">
					<a href="index.php" title="Website IndoState.Cook"><img class="img-responsive img-full" src="img/slide1.png" width="100%" alt="">
				</div>
				<div class="item">
					<a href="dasar.php?page=login_tambah" title="Menambah Resep"><img class="img-responsive img-full" src="img/slide2.png" width="100%" alt=""></a>
				</div>
				<div class="item">
					<a href="dasar.php?page=forum" title="Forum Diskusi"><img class="img-responsive img-full" src="img/slide3.png" width="100%" alt=""></a>
				</div>
			</div>
	...
	<div class="col-sm-5">	
		<center><span class='glyphicon glyphicon-minus'></span> <font color="#990012" size='5'><span class='glyphicon glyphicon-grain'></span></font> <span class='glyphicon glyphicon-minus'></span></center><br>
		<style>
.col-sm-5 p {
    text-indent: 50px;
	font-family: Georgia, serif;
		...
		<p align="justify"><font size="3">IndoState.Cook (<a href="http://indostatecook.com/">indostatecook.com</a>) merupakan sebuah website mengenai Resep Masakan Indonesia yang menyediakan sarana bagi pengguna untuk berbagi informasi. Fasilitas yang disediakan pada website ini adalah fasilitas untuk mencari resep masakan berdasarkan kategori jenis masakan, bahan utama masakan, teknik memasak dan asal masakan. Website ini juga menyediakan fasilitas untuk menulis dan membagikan resep, serta fasilitas untuk berdiskusi pada forum. Website ini dibuat dengan harapan dapat memberikan informasi pada masyarakat yang gemar memasak.</font></p>
		<center><span class='glyphicon glyphicon-minus'></span> <font color="#990012" size='5'><span class='glyphicon glyphicon-grain'></span></font> <span class='glyphicon glyphicon-minus'></span></center>
	...
	<div class="col-sm-12">
		...
		<?php
						require "conn.php";
						$terbaru = mysql_query ("SELECT * from resep WHERE YEAR(tgl_resep) = YEAR(CURRENT_DATE - INTERVAL 1 MONTH) AND MONTH(tgl_resep) = MONTH(CURRENT_DATE - INTERVAL 1 MONTH) order by tgl_resep desc limit 20") or die(mysql_error());
						$terbaru2 = mysql_query ("SELECT * from resep WHERE YEAR(tgl_resep) = YEAR(CURRENT_DATE) AND MONTH(tgl_resep) = MONTH(CURRENT_DATE) order by tgl_resep desc limit 20") or die(mysql_error());
						$terbaru3 = mysql_query ("SELECT * from resep order by tgl_resep desc limit 20") or die(mysql_error());
						$row3 = mysql_num_rows($terbaru3);
						$row = mysql_num_rows($terbaru);
						$row2 = mysql_num_rows($terbaru2);
					if ($row2 >= 4)
					{
					?>
		<div class="judul"><font color="#990012" size='4'><b>RESEP TERBARU BULAN INI</b></font></div>
				...
				<table border='0' class="table" border="0">	
					...
					<?php
						$c=1;
						while ($b=mysql_fetch_array($terbaru2)) 
						{
						$id=$b['id_anggota'];
						...
						echo "
						<td width='25%'>
							<center><a href='dasar.php?page=masakan&id=".$id_resep."' title='".$b['nama_resep']."'><img src='imgresep/".$b['foto_resep']."'><br>
							<h5>".$b['nama_resep']."</h5><br></a></center>
							<center><table border='0' width='220'>
									<tr>
										<td width='30' align='center'>
											<a href='dasar.php?page=profil&id=".$id."' title='Profil ".$a['nama']."'>";
										...
										<td align='center'><b><a href='dasar.php?page=profil&id=".$id."' title='Profil ".$a['nama']."'><font size='2pt'>".$a['nama']."</font></a></b></td>
										<td width='70' align='center'>".date("d/m/Y",strtotime($b['tgl_resep']))."</td>
									</tr>
							</table></center>
							<br>
							<p align='justify'>
...
//-------------------------------------------------------
					...
					{
					?>
						<div class="judul"><font color="#990012" size='4'><b>RESEP TERBARU</b></font></div>
				<div class="table-responsive">
				<table border='0' class="table" border="0">	
					<tbody>
					<tr>
					<?php
						$c=1;
						while ($b=mysql_fetch_array($terbaru3)) 
						{
						$id=$b['id_anggota'];
						$anggota = mysql_query("SELECT * from anggota WHERE id_anggota = '$id'") or die(mysql_error());
						$a=mysql_fetch_array($anggota);
...
//-------------------------------------------------------
					?>
						<div class="judul"><font color="#990012" size='4'><b>RESEP TERBARU BULAN LALU</b></font></div>
				<div class="table-responsive">
				<table border='0' class="table" border="0">	
					<tbody>
					<tr>
					<?php
						$c=1;
						while ($b=mysql_fetch_array($terbaru)) 
						{
						$id=$b['id_anggota'];
						$anggota = mysql_query("SELECT * from anggota WHERE id_anggota = '$id'") or die(mysql_error());
						$a=mysql_fetch_array($anggota);
